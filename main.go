...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		cli.StringFlag{
			Name:   "commit.authorEmail",
			Usage:  "git author email",
			EnvVar: "DRONE_COMMIT_AUTHOR_EMAIL",
		},
		cli.StringFlag{
			Name:   "commit.authorAvatar",
...
func run(c *cli.Context) error {
	plugin := Plugin{
		...
		Build: Build{
			...
			AuthorEmail:  c.String("commit.authorEmail"),
			AuthorAvatar: c.String("commit.authorAvatar"),
			AuthorName:   c.String("commit.authorName"),
